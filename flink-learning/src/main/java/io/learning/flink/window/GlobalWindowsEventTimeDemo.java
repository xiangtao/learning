...
/**
 * key stream globalWindow
 */
public class GlobalWindowsEventTimeDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        orangeStream.keyBy(0)
            ...
            .apply(new WindowFunction<Tuple3<String, String, Long>, Object, Tuple, GlobalWindow>() {
                @Override
                public void apply(Tuple tuple, GlobalWindow window,
                    Iterable<Tuple3<String, String, Long>> input, Collector<Object> out)
                    throws Exception {
                    System.out.println(new Date() + "==" + window.toString());
                    out.collect(input);
                }
            }).name("GlobalWindow").print("out");

        System.out.println(env.getExecutionPlan());

        env.execute("GlobalWindow Demo");
    }
